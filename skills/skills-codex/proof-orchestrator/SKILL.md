...
7. Dispatch only with explicit authorization and an installed route.
   ...
   - Switch to Codex execution only when the user explicitly asks Codex to call or operate GPT Pro for this run and a compatible `call-gpt-pro` skill is installed.
